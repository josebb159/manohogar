...
class ChatScreenSupport extends StatefulWidget {
  const ChatScreenSupport({super.key});

  @override
  _ChatScreenSupportState createState() => _ChatScreenSupportState();
}

class _ChatScreenSupportState extends State<ChatScreenSupport> {
  List chatMessages = [];
  ...
  Future<void> getChatMessages() async {
    try {
      ...
      final response = await http.post(
        Uri.parse('https://manohogar.online/api/app_api.php?action=get_chat_messages_suport'),
  ...
  Future<void> sendChatMessage(String mensaje) async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('https://manohogar.online/api/app_api.php?action=send_chat_message_suport'),
        headers: {'Content-Type': 'application/json'},
